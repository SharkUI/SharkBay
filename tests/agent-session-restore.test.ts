...
describe("agent session restore commands", () => {
  it("infers supported agents from task frontmatter agent names", () => {
    ...
    expect(inferAgentSessionRestoreAgent("Reasonix")).toBe("reasonix");
  ...
  it("builds agent-specific restore commands", () => {
    ...
    expect(commandFor("Reasonix", sessionId)).toBe("SHARKBAY_RESTORED_SESSION_ID='11111111-1111-4111-8111-111111111111' 'reasonix' --resume");
