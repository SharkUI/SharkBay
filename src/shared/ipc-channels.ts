export const ipcChannels = {
  ...
  listGitBranches: "projects:listBranches",
  getWorktreeInfo: "projects:getWorktreeInfo",
  getWorktreeStatus: "projects:getWorktreeStatus",
  removeWorktree: "config:removeWorktree",
