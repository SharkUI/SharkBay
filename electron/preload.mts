...
const sharkBayApi = {
  ...
  config: {
    ...
    removeWorktree: (input: RemoveWorktreeInput) => invoke<RemoveWorktreeResult>(channels.removeWorktree, input),
  ...
  projects: {
    ...
    listGitBranches: (input: ListGitBranchesInput) => invoke<GitBranchSummary>(channels.listGitBranches, input),
    getWorktreeInfo: (input: WorktreeInfoInput) => invoke<WorktreeInfoResult>(channels.getWorktreeInfo, input),
    getWorktreeStatus: (input: WorktreeStatusInput) => invoke<WorktreeStatus>(channels.getWorktreeStatus, input)
  },
  terminal: {
