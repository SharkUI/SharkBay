...
const dispatchers: Record<CoreMethodName, Dispatcher> = {
  ...
  listGitBranches: ([runtime, input]) => core.listGitBranches(runtime as never, input as never),
  getWorktreeInfo: ([runtime, input]) => core.getWorktreeInfo(runtime as never, input as never),
  getWorktreeStatus: ([runtime, input]) => core.getWorktreeStatus(runtime as never, input as never),
  createWorktree: ([runtime, input]) => core.createWorktree(runtime as never, input as never),
  removeWorktree: ([runtime, input]) => core.removeWorktree(runtime as never, input as never),
