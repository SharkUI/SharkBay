...
status: completed
completedAt: 2026-05-30T02:51:48Z
actor: SharkUI
...
updatedAt: 2026-05-30T02:51:48Z
---

## Summary
When launching Kiro from the agent button with status hooks enabled, automatically add `--agent sharkbay` to the launch command.

## Files
- src/renderer/App.tsx

## Work
- Add `--agent sharkbay` flag to Kiro launch command when hooks are enabled.
